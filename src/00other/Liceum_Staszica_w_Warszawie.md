...
Mat fiz to zwykły profil z rozszerzeniem, a matex to taka klasa gdzie nie masz takiego przedmiotu jak matma, tylko masz np analizę albo rachunek prawdopodobieństwa. Matex przygotuje cię na olimpiadę z matmy

nie musisz mieć konkursu kuratoryjnego, nie wiem czemu wszyscy mówią, że każdy uczeń ma kuratoryjnego. Dość dużo takich nie ma. Jedyne co, to trzeba się utrzymywać na wodzie i mieć mega dobre wyniki z egzaminu 8-klasisty (95%+)
...
Z tym, że w 2017 był w ogóle bardzo dobry rocznik i powstała trzecia klasa mateksowa bo w dwóch laureaci nie mieścili się. Natomiast do mat infu przyjęto i w 2017 i 2018 wszystkich laureatów powiększając limit osób. W tym roku też tak będzie. W najgorszym razie powstanie dodatkowa klasa - tak więc nie ma się czym na zapas martwić. Przesunięcie do mat-fizu nikomu z uprawnieniami nie grozi. Bardziej można się martwić o nauczycieli jeśli taki rozrost będzie konieczny. ale na razie statystyki wygladają bardzo dobrze.
...
Ten rok będzie dla członków komisji rekrutacyjnej w Staszicu czystym koszmarem. Potencjalna szkoła pierwszego wyboru dla szczególnie licznej rzeszy uczniów to weryfikacja nie setek, ale tysięcy wniosków. Syzyfowa praca, a 80% tych podań i tak trafi do innych szkół. A potem całe wakacje procedur odwoławczych, dysputy z rodzicami, straszenie prokuratorem. Wcale nie dziwię się kwaśnym humorom pań, które dostąpiły zaszczytu kierowania tą rekrutacją...

Informacja telefoniczna z dzisiaj - w klasach po podstawówce będą dwie 36 osobowe klasy (tylu jest laureatów OMJ i kuratoryjnych matematycznych + 4 osoby osiągnęły maksimum punktów ze sprawdzianu predyspozycji). Ze względu na nadpodaż laureatów chętnych do mat-fiz-inf będzie utworzona jedna dodatkowa klasa o tym profilu.

https://forum.gazeta.pl/forum/w,427,167668156,167668156,Staszic_matex_czy_mat_inf_Co_wybrac_.html

Musi się udać jednozmianowość, bo mamy ogromną liczbę zajęć dodatkowych popołudniu i na godzinach zerowych. To jest u nas kluczowy element – dodaje Agnieszka Potocka, dyrektorka XIV LO w Warszawie
...
https://wiadomosci.radiozet.pl/polska/rekrutacja-do-szkol-ponadpodstawowych-2023-kolejny-wiekszy-rocznik-jeszcze-wieksze-problemy
...
Nie uczę się tam, ale wiedzę pozyskuję z pierwszej ręki. Z jednej strony- mają ciężko. Pierwszy rok (bo tego nie mozna nazwać klasą) to ostra jazda z przedmiotami matematycznymi. Średnia 2, w klasie może jest jeden-dwóch większych orłów (nawet jak na standardy matex-a), ale pozostali - roznoszą studentów jakichkolwiek średniej klasy studiów wyższych... klasa/kierunek w sumie stworzony przez matematyka ze szkoły lwowskiej... drugi rok to wyrównanie poziomu, trzeci - to tylko nauka do matury (ale pod kątem - mieć 95% minimu rozszerzonej matematyki)... uczniowie tej klasy z ich poziomem wiedzy i umiejętności poruszania sie wśród problemów matematycznych uciekają z Polski. Ta pierwsza ręka (skąd wiem co i jak w matexie) zdobyła 1550 pkt na amerykańskim SAT (w połowie drugiej klasy), a subject tests (matematyka i fizyka) na max (każdy po 800 pkt). I było to pierwsze podejście do tego egzaminu...

https://matematyka.pl/viewtopic.php?t=411986

W Staszicu najbardziej cenię dwie rzeczy: wsparcie absolwentów - kola przez nich prowadzone i to, ze nie przeszkadza się uczyć :) Także inne przedmioty poza matematyką nie są żadnym problemem. Prowadzone często znakomicie, wiedza egzekwowana w sposób satysfakcjonujący obie strony. Problemem w mateksach jest matematyka. To sprawdziany z niej zalicza się po kilka razy, olimpijczycy też. Chyba jak sięgam pamięcią nie uchował się nikt w córki klasie, kto ani razu nie poprawiał. Z 28 osób 6 zmieniło szkołę/klasę. 16 osób ma tytuł przynajmniej jednego finalisty olimpiady. Chyba nikt nie został finalistą OM bez uprzedniego przynajmniej finału w OMJ. Z OI juz tak, można zaczać później. Tyle statystyki.
Chce być mateksem, to pewnie żadna siła go nie odwiedzie.
