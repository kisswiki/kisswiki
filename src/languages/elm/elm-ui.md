...
Ah, yeah, the current way to do that is to capture your spacing (specyfing? roman) a font values in a palette file and always use those.  Then you could do things like set the padding based on font size or whatever you’d like.
