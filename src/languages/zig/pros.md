...
- return in Zig is always ending with semicolon. In Rust it is expression if it doesn't have semicolon. So it is harder to grasp what is going on in Rust.
