...
- http://www.pomelloapp.com/ - great integration with trello: saves time spent as comments to in card, adds pomelo icon to card title with how many spent, no ios app, can move to other column after pomodoro ends, need to click "continue after break" to start break
