...
- ios vs android
  ...
  - some common reasons for developing for iOS first is because it is easier, and more lucrative. You only have so many iOS devices to support and test for, and it is easy to target the latest version of the OS because you know that majority of users are already on them. The hardware is pretty standard. http://www.androidauthority.com/develop-apps-for-android-rather-than-ios-607219/
